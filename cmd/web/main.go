...
import (
	...
	"github.com/wandachu/bookings/internal/handlers"
...
func run() (*driver.DB, error) {
	...
	// Mail channel (close in main())
	mailChan := make(chan models.MailData)
	app.MaliChan = mailChan
	...
	db, err := driver.ConnectSQL("host=localhost port=5432 dbname=bookings user=postgres password=abc123")
	if err != nil {
